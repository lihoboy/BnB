...
def main():
    ...
    Summary_Gap=open("Summary\\Summary_Gap"+dt_str+".txt","a")
    ...
    Summary_Gap = open("Summary\\Summary_Node" + dt_str+".txt", "a")
    # Summary_Gap.write("%s\t" % dt_str)
    ...
    Summary_Gap = open("Summary\\Summary_Time" + dt_str+".txt", "a")
    # Summary_Gap.write("%s\t" % dt_str)
...
def BB(Jobs_toDo,R,E,isnew):
    ...
    if isnew :
        file = open(save_path + "_new.txt", "a")
    else:
        file = open(save_path + "_old.txt", "a")
